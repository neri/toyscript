...
| `boolean` | 1?   | 1       | 1        | No         | `_Bool`               | Boolean Value                           |
| `i8`      | 8    | 1       | 1        | No         | `int8_t`              | Signed Integer Type                     |
| `u8`      | 8    | 1       | 1        | No         | `uint8_t`             | Unsigned Integer Type                   |
| `i16`     | 16   | 2       | 2        | No         | `int16_t`             | Signed Integer Type                     |
| `u16`     | 16   | 2       | 2        | No         | `uint16_t`            | Unsigned Integer Type                   |
| `i32`     | 32   | 4       | 4        | Yes        | `int32_t`             | Signed Integer Type                     |
| `u32`     | 32   | 4       | 4        | No         | `uint32_t`            | Unsigned Integer Type                   |
| `i64`     | 64   | 8       | 8        | Yes        | `int64_t`             | Signed Integer Type                     |
| `u64`     | 64   | 8       | 8        | No         | `uint64_t`            | Unsigned Integer Type                   |
