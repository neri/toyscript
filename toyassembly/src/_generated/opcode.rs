...
impl WasmOpcode {
    ...
    pub fn from_top_i32(top: toyir::Op) -> Option<Self> {
        match top {
            ...
            toyir::Op::Clz => Some(Self::I32Clz),
            toyir::Op::Ctz => Some(Self::I32Ctz),
            toyir::Op::Popcnt => Some(Self::I32Popcnt),
            ...
            toyir::Op::Rotl => Some(Self::I32Rotl),
            toyir::Op::Rotr => Some(Self::I32Rotr),
            _ => None
        }
    }
    ...
    pub fn from_top_i64(top: toyir::Op) -> Option<Self> {
        match top {
            ...
            toyir::Op::Clz => Some(Self::I64Clz),
            toyir::Op::Ctz => Some(Self::I64Ctz),
            toyir::Op::Popcnt => Some(Self::I64Popcnt),
            ...
            toyir::Op::Rotl => Some(Self::I64Rotl),
            toyir::Op::Rotr => Some(Self::I64Rotr),
            _ => None
        }
    }
